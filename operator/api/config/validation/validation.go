...
func validateTopologyConfiguration(cfg configv1alpha1.TopologyConfiguration, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	if cfg.Enabled && len(strings.TrimSpace(cfg.Name)) == 0 {
